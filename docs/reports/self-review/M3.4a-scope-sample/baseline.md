...
- changed_files: `5`
- staged_files: `0`
- out_of_scope_dirty_files: `32`
- ui_global_status: `running`
- ui_display_title: `RUNNING`
- writer_status: `ok`
- signal_records: `80`
- recent_sources: `codex_appserver, codex_hook, explicit`
- task_count: `283`
