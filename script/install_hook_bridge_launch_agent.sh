...
env = {
    ...
    "TASKLIGHT_HOOK_TURN_LEASE_SECONDS": os.environ.get("TASKLIGHT_HOOK_TURN_LEASE_SECONDS", "300"),
    "TASKLIGHT_HOOK_COMPLETED_IDLE_RELEASE_SECONDS": os.environ.get("TASKLIGHT_HOOK_COMPLETED_IDLE_RELEASE_SECONDS", "300"),
    ...
    "TASKLIGHT_HOOK_BRIDGE_MAX_SIGNALS_PER_CYCLE": os.environ.get("TASKLIGHT_HOOK_BRIDGE_MAX_SIGNALS_PER_CYCLE", "20"),
    "TASKLIGHT_HOOK_BRIDGE_MAX_BINDING_STATUS_CHECKS": os.environ.get("TASKLIGHT_HOOK_BRIDGE_MAX_BINDING_STATUS_CHECKS", "12"),
