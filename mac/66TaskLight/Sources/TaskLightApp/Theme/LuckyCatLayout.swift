...
enum LuckyCatLayout {
    ...
    static let compactBottomBandHorizontalPadding: CGFloat = 8
    static let compactBottomBandLeftTextWidth: CGFloat = 92
    static let compactBottomBandRightTextWidth: CGFloat = 116
    static let compactBottomBandCenterGap: CGFloat = 30
    static let compactBottomBandQuotaTextSize: CGFloat = 16.6
    static let compactBottomBandRightLabelSpacing: CGFloat = 1
    static let compactBottomBandRightTextOffsetX: CGFloat = -14
    static let compactBottomBandTextSize: CGFloat = 18.8
    static let compactBottomBandStatusTextOffsetX: CGFloat = 5
